...
import static com.after_project.appmessenger.MessengerConnection.ConnectionStatus.ERROR_CONNECTION_NORMAL_NO_MATCHS_FOUND;
import static com.after_project.appmessenger.MessengerConnection.ConnectionStatus.ERROR_CONNECTION_TAG_NOT_REGISTERED;
import static com.after_project.appmessenger.MessengerConnectionManager.ConnectionType.CONNECTION_MULTCLIENT;
import static com.after_project.appmessenger.MessengerConnectionManager.ConnectionType.CONNECTION_MULTCLIENT_ONLY_IF_MATCHS_ELSE_CONNECTION_NORMAL_IF_MATCHS;
import static com.after_project.appmessenger.MessengerConnectionManager.ConnectionType.CONNECTION_MULTCLIENT_ONLY_IF_MATCHS_ELSE_CONNECTION_NORMAL_NO_RULES;
import static com.after_project.appmessenger.MessengerConnectionManager.ConnectionType.CONNECTION_NORMAL;
...
and if you CONNECTION_MULTCLIENT then use  ConnectionMulticlientMatchByNames
        */
        ...
        connectionPolicies.add(new ConnectionPolicy(MainActivity2.class, CONNECTION_MULTCLIENT,
                1, new ConnectionRules(false,0, new ConnectionMulticlientMatchByNames("main2")))  );
                                ...
                                if (connectionRulesMatch.rulesMatchType.equals(RulesMatchType.MATCH_TYPE_NAME) ) {
                                    if (!connectionRulesMatch.matchWith(connectionRulesMatch.toArray(), connection.getName())) {
                                        if ( ! registry.connectionType.equals(CONNECTION_MULTCLIENT_ONLY_IF_MATCHS_ELSE_CONNECTION_NORMAL_NO_RULES)) {
                                            return connectionRulesMatch.connectionType.equals(CONNECTION_MULTCLIENT)? MessengerConnection.ConnectionStatus.ERROR_CONNECTION_MULTCLIENT_NO_MATCHS_FOUND: ERROR_CONNECTION_NORMAL_NO_MATCHS_FOUND;
                                        }
                                    } else {
